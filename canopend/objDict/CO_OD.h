...
/*******************************************************************************
   FILE INFO:
      FileName:     DRIVE_OD.xml
      FileVersion:  0
      CreationTime: 12:09AM
...
/*3000    */ typedef struct {
               UNSIGNED8      maxSubIndex;
               UNSIGNED16     devStatus;
               INTEGER16      devErrorReg;
               INTEGER32      devCmdResult;
               }              OD_micontrol1Status_t;
/*3001    */ typedef struct {
               UNSIGNED8      maxSubIndex;
               UNSIGNED16     devStatus;
               INTEGER16      devErrorReg;
               INTEGER32      devCmdResult;
               }              OD_micontrol2Status_t;
/*3002    */ typedef struct {
               UNSIGNED8      maxSubIndex;
               UNSIGNED16     devStatus;
               INTEGER16      devErrorReg;
               INTEGER32      devCmdResult;
               }              OD_micontrol3Status_t;
/*3003    */ typedef struct {
               UNSIGNED8      maxSubIndex;
               UNSIGNED16     devStatus;
               INTEGER16      devErrorReg;
               INTEGER32      devCmdResult;
               }              OD_micontrol4Status_t;
/*4000    */ typedef struct {
               UNSIGNED8      maxSubIndex;
               INTEGER16      cmdData0_i16;
               INTEGER8       cmdData2;
               INTEGER32      cmdData1;
               UNSIGNED8      cmdExecOnChange;
               }              OD_micontrolCmd1_t;
/*4001    */ typedef struct {
               UNSIGNED8      maxSubIndex;
               INTEGER16      cmdData0_i16;
...
/*3000 */
        #define OD_3000_micontrol1Status                            0x3000

        #define OD_3000_0_micontrol1Status_maxSubIndex              0
        #define OD_3000_1_micontrol1Status_devStatus                1
        #define OD_3000_2_micontrol1Status_devErrorReg              2
        #define OD_3000_3_micontrol1Status_devCmdResult             3

/*3001 */
        #define OD_3001_micontrol2Status                            0x3001

        #define OD_3001_0_micontrol2Status_maxSubIndex              0
        #define OD_3001_1_micontrol2Status_devStatus                1
        #define OD_3001_2_micontrol2Status_devErrorReg              2
        #define OD_3001_3_micontrol2Status_devCmdResult             3

/*3002 */
        #define OD_3002_micontrol3Status                            0x3002

        #define OD_3002_0_micontrol3Status_maxSubIndex              0
        #define OD_3002_1_micontrol3Status_devStatus                1
        #define OD_3002_2_micontrol3Status_devErrorReg              2
        #define OD_3002_3_micontrol3Status_devCmdResult             3

/*3003 */
        #define OD_3003_micontrol4Status                            0x3003

        #define OD_3003_0_micontrol4Status_maxSubIndex              0
        #define OD_3003_1_micontrol4Status_devStatus                1
        #define OD_3003_2_micontrol4Status_devErrorReg              2
        #define OD_3003_3_micontrol4Status_devCmdResult             3

/*4000 */
        #define OD_4000_micontrolCmd1                               0x4000

        #define OD_4000_0_micontrolCmd1_maxSubIndex                 0
        #define OD_4000_1_micontrolCmd1_cmdData0_i16                1
        #define OD_4000_2_micontrolCmd1_cmdData2                    2
        #define OD_4000_3_micontrolCmd1_cmdData1                    3
        #define OD_4000_4_micontrolCmd1_cmdExecOnChange             4

/*4001 */
        #define OD_4001_micontrolCmd2                               0x4001

        #define OD_4001_0_micontrolCmd2_maxSubIndex                 0
        #define OD_4001_1_micontrolCmd2_cmdData0_i16                1
        #define OD_4001_2_micontrolCmd2_cmdData2                    2
        #define OD_4001_3_micontrolCmd2_cmdData1                    3
        #define OD_4001_4_micontrolCmd2_cmdExecOnChange             4

/*4002 */
        #define OD_4002_micontrolCmd3                               0x4002

        #define OD_4002_0_micontrolCmd3_maxSubIndex                 0
        #define OD_4002_1_micontrolCmd3_cmdData0_i16                1
        #define OD_4002_2_micontrolCmd3_cmdData2                    2
        #define OD_4002_3_micontrolCmd3_cmdData1                    3
        #define OD_4002_4_micontrolCmd3_cmdExecOnChange             4

/*4003 */
        #define OD_4003_micontrolCmd4                               0x4003

        #define OD_4003_0_micontrolCmd4_maxSubIndex                 0
        #define OD_4003_1_micontrolCmd4_cmdData0_i16                1
        #define OD_4003_2_micontrolCmd4_cmdData2                    2
        #define OD_4003_3_micontrolCmd4_cmdData1                    3
        #define OD_4003_4_micontrolCmd4_cmdExecOnChange             4
...
/*1008      */ VISIBLE_STRING  manufacturerDeviceName[5];
...
/*2130      */ OD_time_t       time;
/*3000      */ OD_micontrol1Status_t micontrol1Status;
/*3001      */ OD_micontrol2Status_t micontrol2Status;
/*3002      */ OD_micontrol3Status_t micontrol3Status;
/*3003      */ OD_micontrol4Status_t micontrol4Status;
/*4000      */ OD_micontrolCmd1_t micontrolCmd1;
/*4001      */ OD_micontrolCmd2_t micontrolCmd2;
/*4002      */ OD_micontrolCmd3_t micontrolCmd3;
/*4003      */ OD_micontrolCmd4_t micontrolCmd4;
...
/*1008, Data Type: VISIBLE_STRING */
        ...
        #define ODL_manufacturerDeviceName_stringLength             5
...
/*3000, Data Type: micontrol1Status_t */
        #define OD_micontrol1Status                                 CO_OD_RAM.micontrol1Status

/*3001, Data Type: micontrol2Status_t */
        #define OD_micontrol2Status                                 CO_OD_RAM.micontrol2Status

/*3002, Data Type: micontrol3Status_t */
        #define OD_micontrol3Status                                 CO_OD_RAM.micontrol3Status

/*3003, Data Type: micontrol4Status_t */
        #define OD_micontrol4Status                                 CO_OD_RAM.micontrol4Status

/*4000, Data Type: micontrolCmd1_t */
        #define OD_micontrolCmd1                                    CO_OD_RAM.micontrolCmd1

/*4001, Data Type: micontrolCmd2_t */
        #define OD_micontrolCmd2                                    CO_OD_RAM.micontrolCmd2

/*4002, Data Type: micontrolCmd3_t */
        #define OD_micontrolCmd3                                    CO_OD_RAM.micontrolCmd3

/*4003, Data Type: micontrolCmd4_t */
        #define OD_micontrolCmd4                                    CO_OD_RAM.micontrolCmd4
